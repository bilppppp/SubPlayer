...
- `POST /api/asr/upload/init`
- `PUT /api/asr/upload/:id/chunk`
- `POST /api/asr/upload/:id/complete`
- `DELETE /api/asr/upload/:id`
- `POST /api/asr/transcribe-upload`
- `POST /api/asr/transcribe-upload-live`
